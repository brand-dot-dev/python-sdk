...
class BrandResource(SyncAPIResource):
    ...
    def with_raw_response(self) -> BrandResourceWithRawResponse:
        ...
        For more information, see https://www.github.com/stainless-sdks/brand.dev-python#accessing-raw-response-data-eg-headers
        """
    ...
    def with_streaming_response(self) -> BrandResourceWithStreamingResponse:
        ...
        For more information, see https://www.github.com/stainless-sdks/brand.dev-python#with_streaming_response
        """
